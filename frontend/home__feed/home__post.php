<?php
// query
$tweet_query = "SELECT `tweet_id`,`tweet`,`tweet_img`,`user_name`,`user_profile_name`,`user_dp` from bakbak_tweet bt INNER JOIN bakbak_user_data bud ON bt.user_id = bud.user_id ORDER BY bt.tweet_id DESC ";
session_start();
// database connectes
